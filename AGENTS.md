# AI Agent Instructions: FFC-EX-bintobetter.org
...
These sites deploy to `https://freeforcharity.github.io/FFC-EX-bintobetter.org/` and optionally to a custom domain if one is configured for this repo.
