...
export const cookiePolicy: LegalSection = {
  ...
  body: [
    ...
    `What happens by default depends on where you are. In the UK, the EEA and Switzerland, nothing is switched on until you say so: the banner on your first visit asks you to choose, and analytics stays off — storing nothing — until you allow it. Everywhere else, analytics is on and the banner offers you a way to decline.`,
    `Either way the decision is yours and it is not final. Declining switches analytics off for this browser going forward and deletes the analytics cookies already set, and you can change your mind at any time using the "Cookie Settings" link in the footer. Your choice is remembered in your browser's local storage rather than in a cookie.`,
