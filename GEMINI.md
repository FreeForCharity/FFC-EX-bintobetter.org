# Gemini Instructions: FFC-EX-bintobetter.org

Hey Gemini! Welcome to FFC-EX-bintobetter.org.

**Project:** FFC-EX-bintobetter.org -- a Free For Charity nonprofit website for bintobetter.org
...
The site deploys to `https://freeforcharity.github.io/FFC-EX-bintobetter.org/` (and your custom domain if configured). The `assetPath()` function from `src/lib/assetPath.ts` handles this automatically.
